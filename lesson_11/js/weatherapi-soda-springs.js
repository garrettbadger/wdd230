const apiURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=3a3f5ad2113c8cab626ffe00ab5469a5&units=imperial'
fetch(apiURL)
...
const apiURL2 = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=3a3f5ad2113c8cab626ffe00ab5469a5&units=imperial'
fetch(apiURL2)
    .then((response) => response.json())
    .then((jsObject) => {
